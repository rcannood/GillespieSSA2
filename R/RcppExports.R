...
test_ssa_method_cpp <- function(ssa_alg, state, propensity, nu_i, nu_p, nu_x) {
    .Call('_gillespie_test_ssa_method_cpp', PACKAGE = 'gillespie', ssa_alg, state, propensity, nu_i, nu_p, nu_x)
}

test_propensity_cpp <- function(num_functions, propensity_funs, params, buffer_size, propensity_size, state, sim_time) {
    .Call('_gillespie_test_propensity_cpp', PACKAGE = 'gillespie', num_functions, propensity_funs, params, buffer_size, propensity_size, state, sim_time)
}
