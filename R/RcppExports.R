...
make_ode_em <- function(tau, noise_strength) {
    .Call('_fastgssa_make_ode_em', PACKAGE = 'fastgssa', tau, noise_strength)
}
...
simulate <- function(propensity_funs, num_functions, ssa_alg, initial_state, params, nu_i, nu_p, nu_x, final_time, census_interval, buffer_size, max_walltime, stop_on_neg_state, verbose, console_interval) {
    .Call('_fastgssa_simulate', PACKAGE = 'fastgssa', propensity_funs, num_functions, ssa_alg, initial_state, params, nu_i, nu_p, nu_x, final_time, census_interval, buffer_size, max_walltime, stop_on_neg_state, verbose, console_interval)
}
